...
class PackCLSInputs(BaseTransform):
    def transform(self, results: Dict) -> Dict:
        ...
        packed_results['multi_view_imgs'] = results['multi_view_imgs'] 
        packed_results['multi_view_paths'] = results['multi_view_paths']
        packed_results['render_imgs'] = results['render_imgs']
        packed_results['render_paths'] = results['render_paths']
